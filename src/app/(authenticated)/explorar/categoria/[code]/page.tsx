...
export default function CategoryFeedPage() {
  ...
  const category = getCategoryByCode(code as string);
    ...
    return (
      <div className="fixed inset-0 bg-app-black flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-400 text-sm">Cargando {category.name}...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="fixed inset-0 bg-app-black flex items-center justify-center p-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-400 text-sm">
            Aún no hay videos de categoría {category.name.toLowerCase()}
          </p>
        </div>
      </div>
    );
