      ...
      <div className="px-5 py-6 pb-24">
        {bookmarks.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16">
            ...
            <p className="text-xs text-gray-500 mt-1">Guarda lecciones desde el feed para verlas después</p>
          </div>
        ) : (
            ...
            {bookmarks.map((bm) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-white line-clamp-1">{bm.lesson?.keyLesson || bm.lesson?.title}</p>
                  <p className="text-xs text-gray-400 mt-0.5">{bm.companyTitle} • {bm.companyFounder}</p>
                </div>
                <button
