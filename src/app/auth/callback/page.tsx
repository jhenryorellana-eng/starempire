    ...
    return (
      <div className="min-h-screen bg-app-black flex items-center justify-center p-6">
        <div className="max-w-md w-full text-center animate-fade-in-up">
          <div className="w-20 h-20 bg-gradient-to-br from-primary to-primary-dark rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg" style={{ boxShadow: '0 8px 24px rgba(16, 185, 129, 0.3)' }}>
          ...
          <p className="text-gray-400 mb-8">
            Entra como estudiante de prueba para explorar StarEmpire.
          </p>
          <button
    ...
    return (
      <div className="min-h-screen bg-app-black flex items-center justify-center">
        <div className="text-center animate-fade-in-up">
          <div className="w-20 h-20 bg-gradient-to-br from-primary to-primary-dark rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg" style={{ boxShadow: '0 8px 24px rgba(16, 185, 129, 0.3)' }}>
            <span className="material-icons-round text-white text-4xl">domain</span>
          </div>
          <h1 className="text-2xl font-bold text-white mb-2">StarEmpire</h1>
