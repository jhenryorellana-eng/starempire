  ...
  return (
    <div className="absolute left-0 w-full z-30" style={{ bottom: bottomPx }}>
      ...
      <div className="w-full h-1 bg-white/20">
        <div
          className="h-full bg-gradient-to-r from-primary to-emerald-400 rounded-r-full relative transition-[width] duration-200"
          style={{ width: `${progress}%`, boxShadow: '0 0 10px rgba(16, 185, 129, 0.7)' }}
        >
