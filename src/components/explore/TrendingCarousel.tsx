...
export function TrendingCarousel({ companies }: TrendingCarouselProps) {
            ...
            <div className="aspect-[2/3] rounded-xl overflow-hidden relative mb-3 bg-surface-dark shadow-lg shadow-primary/5 border border-white/5 transition-transform duration-300 group-hover:-translate-y-1">
              {company.coverUrl ? (
                ...
                <div className="w-full h-full flex items-center justify-center">
                  <span className="material-icons-round text-4xl text-gray-600">domain</span>
                </div>
              )}
              ...
              <div className="absolute bottom-0 left-0 right-0 p-3">
                ...
                <p className="text-[10px] text-gray-400 mt-1 truncate">{company.founder}</p>
                <div className="flex items-center gap-1 mt-1.5">
                  <span className="material-icons-round text-[10px] text-primary">domain</span>
